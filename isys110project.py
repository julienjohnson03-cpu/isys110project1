...
def save_log(team_name, choice_type_text):
    ...
    #PSEUDOCODE:
    # open the log file
    # write the user options to the file
    # save it
        with open(log, "a") as f:
            log_line = f"Team: {team_name} Choice: {choice_type_text}\n"
            f.write(log_line)
...
def team_stats(team):
    ...
    print(tabulate(rows, headers=["Week", "Opponent", "Score"]))
...
def main():
    ...
    # I had trouble finding a way to make the code read the log and return information from it.
    # I used AI to help figure this out, as this is a requirement in the instructions
    ...
    while True:
        ...
        # Ask if the user wants to look up another team, if no give the user a goodbye message
